...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyProfile.Entity.Model.LimitNotification", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyProfile.Entity.Model.Notification", b =>
                {
                    ...
                    b.Property<int?>("LimitNotificationID");

                    b.Property<int>("NotificationTypeID");

                    b.Property<DateTime>("ReadDateTime");

                    b.Property<int?>("ReminderNotificationID");
                    ...
                    b.HasIndex("LimitNotificationID");

                    b.HasIndex("ReminderNotificationID");
            ...
            modelBuilder.Entity("MyProfile.Entity.Model.ReminderNotification", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyProfile.Entity.Model.LimitNotification", b =>
                {
                    b.HasOne("MyProfile.Entity.Model.Limit", "Limit")
                        .WithMany("LimitNotifications")
                        .HasForeignKey("LimitID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MyProfile.Entity.Model.Notification", "Notification")
                        .WithMany()
            ...
            modelBuilder.Entity("MyProfile.Entity.Model.Notification", b =>
                {
                    b.HasOne("MyProfile.Entity.Model.LimitNotification", "LimitNotification")
                        .WithMany()
                        .HasForeignKey("LimitNotificationID");

                    b.HasOne("MyProfile.Entity.Model.ReminderNotification", "ReminderNotification")
                        .WithMany()
                        .HasForeignKey("ReminderNotificationID");
            ...
            modelBuilder.Entity("MyProfile.Entity.Model.UserConnect", b =>
                {
                    b.HasOne("MyProfile.Entity.Model.User", "User")
                        .WithOne("UserConnect")
                        .HasForeignKey("MyProfile.Entity.Model.UserConnect", "ID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MyProfile.Entity.Model.UserConnect")
                        .WithMany("UserConnects")
                        .HasForeignKey("UserConnectID");
                });

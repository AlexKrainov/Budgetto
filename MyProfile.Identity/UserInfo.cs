        ...
        public static UserInfoClientSide GetUserInfoModelForClient()
        {
            ...
            return new UserInfoClientSide
            {
                ...
                UserSettings = new UserSettingsClientSide
                {
                    ...
                    Dashboard_Month_IsShow_Statistics = currentUser.UserSettings.Month_Statistics,
                    ...
                    Dashboard_Year_IsShow_ToDoLists = currentUser.UserSettings.Year_ToDoLists,
                    Dashboard_Year_IsShow_Statistics = currentUser.UserSettings.Year_Statistics,

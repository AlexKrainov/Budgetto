...
$(function () {
    ...
    function setupTour(AddRecordTour) {
        ...
        AddRecordTour.addStep({
            title: 'Шаг 4.',
            text: 'Вы можете выбрать счет, оставить комментарий и добавить тег(и) к записи, а также удалить категорию. <br /> Не покидая диалогового окна, можно добавлять новые записи и выбирать для них нужные параметры.',

...
(function ($) {
    ...
    $.colorPick = function (element, options) {
        ...
        this.localizationColor = $.fn.colorPick.defaults.localizationColor;
    ...
    $.fn.colorPick.defaults = {
        ...
        'palette': [
            "#e2f7e7", "#c5efcf", "#a7e7b7", "#5df192",
            "#e3edf9", "#c6dbf3", "#a9caed", "#5bb4f9",
            "#fff5dc", "#ffeab9", "#ffe196", "#fcd772",
            "#ffe2dc", "#ffc6ba", "#ffa999", "#f98c79",
    ...
    $.colorPick.prototype = {
        ...
        show: function (left, top) {
            ...
            for (var i = 0; i < this.palette.length; i++) {
                ...
                let title = '';
                let localColor = this.localizationColor.find(x => x.ColorCode.toUpperCase() == item);
                if (localColor && localColor.ColorName) {
                    title = localColor.ColorName;
                }
                $("#colorPick").append('<div title="' + title + '" class="colorPickButton" hexValue="' + item + '" style="background:' + item + '"></div>');
            }

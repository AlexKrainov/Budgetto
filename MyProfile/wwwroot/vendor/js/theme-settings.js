					...
					function t(e) {
						...
						if (
							...
							(this.settings = {}),
								...
								(this.settings.cssFilenamePattern = a || u),
								(this.settings.navbarBgs = l || t.NAVBAR_BGS),
								(this.settings.defaultNavbarBg = c || v),
								(this.settings.sidenavBgs = r || t.SIDENAV_BGS),
								(this.settings.defaultSidenavBg = o || m),
								(this.settings.footerBgs = h || t.FOOTER_BGS),
								(this.settings.defaultFooterBg = p || f),
								(this.settings.availableThemes = b || t.AVAILABLE_THEMES),
								(this.settings.defaultTheme = this._getDefaultTheme(void 0 !== y ? y : d)),
								(this.settings.controls = n || g),
								(this.settings.lang = k || "en"),
								(this.pathResolver =
									_ ||
									function (t) {
										return t;
								...
								value: function (t) {
									...
									if (this._hasControls("sidenavBg") && -1 !== this.settings.sidenavBgs.indexOf(t)) {
										...
										if (i) {
											...
											var a = t.split(" ");
											i.classList.contains("sidenav-horizontal") && ((a = a.join(" ").replace(" sidenav-dark", "").replace(" sidenav-light", "").split(" "))[0] = a[0].replace(/-darke?r?$/, "")),
												i.classList.add("bg-".concat(a[0]));
											for (var n = 1, r = a.length; n < r; n++) i.classList.add(a[n]);
											e && this.settings.onSettingsChange.call(this, this.settings);
										}
							...
							},
							{
								...
								value: function () {
									...
									(t =
										...
										(this.settings.material = "" !== i ? "true" === i : e.contains("material-style")),
										(this.settings.layoutPosition = t),
										(this.settings.layoutReversed = "" !== a ? "true" === a : e.contains("layout-reversed")),
										(this.settings.layoutNavbarFixed = "" !== n ? "true" === n : e.contains("layout-navbar-fixed")),
										...
										this._hasControls("material") || (this.settings.material = e.contains("material-style")),
							...
							},
							{
								...
								value: function () {
									...
									this._hasControls("navbarBg")
										? ((this._controls.navbarBgWInner = x.querySelector(".theme-settings-navbarBg-inner")),
									...
									this._hasControls("sidenavBg")
										? ((this._controls.sidenavBgWInner = k.querySelector(".theme-settings-sidenavBg-inner")),
										...
										this.settings.availableThemes.forEach(function (e) {
											...
											(i.value = e.name),
												...
												(s.querySelector(".theme-settings-theme-colors").innerHTML = '\n          <span style="background: '
													.concat(e.colors.primary, '"></span>\n          <span style="background: ')
													.concat(e.colors.navbar, '"></span>\n          <span style="background: ')
													.concat(e.colors.sidenav, '"></span>\n        '));
											var a = function (e) {
												t._loading ||
													((t._loading = !0),
														t._loadingState(!0, !0),
							...
							},
							{
								...
								value: function () {
									if (this._hasControls("material")) {
										...
										this._insertStylesheet("theme-settings-bootstrap-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "bootstrap" + (t ? "-material" : "")))),
											this._insertStylesheet("theme-settings-appwork-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "appwork" + (t ? "-material" : "")))),
											this._insertStylesheet("theme-settings-colors-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "colors" + (t ? "-material" : "")))),
											document.documentElement.classList.remove(t ? "default-style" : "material-style"),
											document.documentElement.classList.add(t ? "material-style" : "default-style"),
											t &&
								...
								value: function () {
									this._hasControls("themes") &&
										this._insertStylesheet(
											...
											this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", this.settings.theme.name + (this.settings.material ? "-material" : "")))
										);
								},
							},
							{

        ...
        541: function (t, e, s) {
                        ...
                        if (
                            ...
                            if (
                                ((this.settings = {}),
                                    ...
                                    (this.settings.defaultTheme = this._getDefaultTheme(void 0 !== f ? f : 1)),
                                ...
                                -1 !== _ && (this.settings.controls = this.settings.controls.slice(0, _).concat(this.settings.controls.slice(_ + 1)));
                            }
                            (this.settings.onSettingsChange = "function" == typeof y ? y : function () { }),
                                this._loadSettings(),
                                (this._listeners = []),
                                (this._controls = {}),
                                this._initDirection(),
                        ...
                        (s = [
                                    ...
                                    this._hasControls("layoutPosition") &&
                                        (("static" !== t && "static-offcanvas" !== t && "fixed" !== t && "fixed-offcanvas" !== t) ||
                                            ((this.settings.layoutPosition = t),
                                                ...
                                                window.layoutHelpers.setPosition("fixed" === t || "fixed-offcanvas" === t, "static-offcanvas" === t || "fixed-offcanvas" === t),
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    this._hasControls("layoutNavbarFixed") &&
                                        ((this.settings.layoutNavbarFixed = t), e && this._setSetting("FixedNavbar", t), window.layoutHelpers.setNavbarFixed(t), e && this.settings.onSettingsChange.call(this, this.settings));
                                },
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    this._hasControls("layoutFooterFixed") &&
                                        ((this.settings.layoutFooterFixed = t), e && this._setSetting("FixedFooter", t), window.layoutHelpers.setFooterFixed(t), e && this.settings.onSettingsChange.call(this, this.settings));
                                },
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    this._hasControls("layoutReversed") &&
                                        ((this.settings.layoutReversed = t), e && this._setSetting("LayoutReversed", t), window.layoutHelpers.setReversed(t), e && this.settings.onSettingsChange.call(this, this.settings));
                                },
                            },
                            {
                                key: "setNavbarBg",
                                ...
                                value: function (t) {
                                    ...
                                    if (this._hasControls("sidenavBg") && -1 !== this.settings.sidenavBgs.indexOf(t)) {
                                        ...
                                        if (i) {
                                            ...
                                            var n = t.split(" ");
                                            i.classList.contains("sidenav-horizontal") && ((n = n.join(" ").replace(" sidenav-dark", "").replace(" sidenav-light", "").split(" "))[0] = n[0].replace(/-darke?r?$/, "")),
                                                i.classList.add("bg-".concat(n[0]));
                                            for (var a = 1, r = n.length; a < r; a++) i.classList.add(n[a]);
                                            e && this.settings.onSettingsChange.call(this, this.settings);
                                        }
                                    ...
                                    if (!this._ssr) {
                                        ...
                                        if (
                                            (this._controls.layoutReversed &&
                                                (e
                                                    ? (this._controls.layoutReversed.removeAttribute("disabled"), this._controls.layoutReversedW.classList.remove("disabled"))
                                                    : (this._controls.layoutReversed.setAttribute("disabled", "disabled"), this._controls.layoutReversedW.classList.add("disabled"))),
                                                ...
                                                (e
                                                    ...
                                                    (!t && !e) || (!e && !i) ? this._controls.layoutPosition.setAttribute("disabled", "disabled") : this._controls.layoutPosition.removeAttribute("disabled")),
                                                this._controls.navbarBgWInner && (t ? this._controls.navbarBgWInner.removeAttribute("disabled") : this._controls.navbarBgWInner.setAttribute("disabled", "disabled")),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    (t =
                                        "" !== h && -1 !== ["static", "static-offcanvas", "fixed", "fixed-offcanvas"].indexOf(h)
                                            ? h
                                            : e.contains("layout-offcanvas")
                                                ...
                                                : e.contains("layout-fixed")
                                                    ...
                                                    : e.contains("layout-fixed-offcanvas")
                                                        ? "fixed-offcanvas"
                                                        : "static"),
                                        (this.settings.rtl = "" !== s ? "true" === s : "rtl" === document.documentElement.getAttribute("dir")),
                                        (this.settings.style = -1 !== this.settings.styles.indexOf(i) ? i : e.contains("material-style") ? "material" : e.contains("dark-style") ? "dark" : "light"),
                                        -1 === this.settings.styles.indexOf(this.settings.style) && (this.settings.style = this.settings.styles[0]),
                                        (this.settings.layoutPosition = t),
                                        (this.settings.layoutReversed = "" !== n ? "true" === n : e.contains("layout-reversed")),
                                        (this.settings.layoutNavbarFixed = "" !== a ? "true" === a : e.contains("layout-navbar-fixed")),
                                        (this.settings.layoutFooterFixed = "" !== r ? "true" === r : e.contains("layout-footer-fixed")),
                                        (this.settings.navbarBg = -1 !== this.settings.navbarBgs.indexOf(o) ? o : this.settings.defaultNavbarBg),
                                        (this.settings.sidenavBg = -1 !== this.settings.sidenavBgs.indexOf(l) ? l : this.settings.defaultSidenavBg),
                                        (this.settings.footerBg = -1 !== this.settings.footerBgs.indexOf(c) ? c : this.settings.defaultFooterBg),
                                        ...
                                        this._hasControls("style") || (this.settings.style = e.contains("material-style") ? "material" : e.contains("dark-style") ? "dark" : "light"),
                                        this._hasControls("layoutPosition") || (this.settings.layoutPosition = null),
                                        this._hasControls("layoutReversed") || (this.settings.layoutReversed = null),
                                        ...
                                        this._hasControls("navbarBg") || (this.settings.navbarBg = null),
                                        this._hasControls("sidenavBg") || (this.settings.sidenavBg = null),
                                        this._hasControls("footerBg") || (this.settings.footerBg = null),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (this._hasControls("style")) {
                                        ...
                                        this.settings.styles.forEach(function (e) {
                                            var s = t._getElementFromString(
                                                '<option value="'
                                                    .concat(e, '" class="theme-settings-t-style_switcher_')
                                                    .concat(e, '" ')
                                                    .concat(t.settings.style === e ? 'selected="selected"' : "", "></option>")
                                            );
                                            u.appendChild(s);
                                        });
                                        var v = function (e) {
                                    ...
                                    this._hasControls("navbarBg")
                                        ? ((this._controls.navbarBgWInner = k.querySelector(".theme-settings-navbarBg-inner")),
                                            this.settings.navbarBgs.forEach(function (e) {
                                                ...
                                                s.classList.add("bg-".concat(e.split(" ")[0])),
                                                    ...
                                                    (i.value = e),
                                                    t.settings.navbarBg === e && (i.setAttribute("checked", "checked"), s.classList.add("active"));
                                                var n = function (e) {
                                    ...
                                    this._hasControls("sidenavBg")
                                        ? ((this._controls.sidenavBgWInner = x.querySelector(".theme-settings-sidenavBg-inner")),
                                            this.settings.sidenavBgs.forEach(function (e) {
                                                ...
                                                s.classList.add("bg-".concat(e.split(" ")[0])),
                                                    ...
                                                    (i.value = e),
                                                    t.settings.sidenavBg === e && (i.setAttribute("checked", "checked"), s.classList.add("active"));
                                                var n = function (e) {
                                    ...
                                    this._hasControls("footerBg")
                                        ? ((this._controls.footerBgWInner = S.querySelector(".theme-settings-footerBg-inner")),
                                            this.settings.footerBgs.forEach(function (e) {
                                                ...
                                                s.classList.add("bg-".concat(e.split(" ")[0])),
                                                    ...
                                                    (i.value = e),
                                                    t.settings.footerBg === e && (i.setAttribute("checked", "checked"), s.classList.add("active"));
                                                var n = function (e) {
                                    ...
                                    if (this._hasControls("themes")) {
                                        ...
                                        this.settings.availableThemes.forEach(function (e) {
                                            ...
                                            (i.value = e.name),
                                                t.settings.theme.name === e.name && i.setAttribute("checked", "checked"),
                                                (s.querySelector(".theme-settings-theme-colors").innerHTML = '\n          <span style="background: '
                                                    .concat(n.primary, '"></span>\n          <span style="background: ')
                                                    .concat(n.navbar, '"></span>\n          <span style="background: ')
                                ...
                                value: function () {
                                    if (this._hasControls("style")) {
                                        ...
                                        this._insertStylesheet(
                                            ...
                                            this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "bootstrap" + ("light" !== t ? "-".concat(t) : "")))
                                        ),
                                            this._insertStylesheet(
                                                "theme-settings-appwork-css",
                                                this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "appwork" + ("light" !== t ? "-".concat(t) : "")))
                                            ),
                                            this._insertStylesheet("theme-settings-colors-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "colors" + ("light" !== t ? "-".concat(t) : "")))),
                                            ("light" === t ? ["material-style", "dark-style"] : "material" === t ? ["light-style", "dark-style"] : ["light-style", "material-style"]).forEach(function (t) {
                                ...
                                value: function (t, e) {
                                    ...
                                    for (var r = 0; r < s.length; r++)
                                        a(s[r], t[s[r]], function (t, s) {
                                            t || (console && "function" == typeof console.error && console.error("Error occured while loading stylesheets!"), alert("Error occured while loading stylesheets!"), console.log(s)),
                                                ++n >= i && e();
                                        });
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    this._addObserver(
                                        ...
                                        !document.body &&
                                        ((this._observers && this._observers.length) || (this._intervals && this._intervals.length)) &&
                                        ...
                                        document.querySelector(t)
                                            ...
                                            ("undefined" != typeof MutationObserver
                                                ? ((i = new MutationObserver(function (t) {
                                                    ...
                                                    i.observe(document.documentElement, { childList: !0, subtree: !0, attributes: !1, characterData: !1 }))
                            ...
                            },
                            {
                                key: "_getThemeByName",
                                value: function (t) {
                                    for (var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], s = this.settings.availableThemes, i = 0, n = s.length; i < n; i++) if (s[i].name === t) return s[i];
            ...
            (u.AVAILABLE_THEMES = [
                ...
                { name: "theme-cotton", title: "Сotton", colors: { primary: "#e84c64", navbar: "#ffffff", sidenav: "#ffffff" }, colorsDark: { primary: "#e84c64", navbar: "#25282e", sidenav: "#d2d3d4" } },
                {
                    ...
                    colorsDark: { primary: "#775cdc", navbar: "#1c1f24", sidenav: "linear-gradient(to top, #4e54c8, #8c55e4)" },
                },
        ...
        89: function (t, e, s) {
            ...
            function l(t, e) {
                for (var s = {}, i = [], n = 0; n < t.length; n++) {
                    ...
                    -1 !== d ? (r[d].references++, r[d].updater(g)) : r.push({ identifier: h, updater: f(g, e), references: 1 }), i.push(h);
                }
                return i;
            }
            function c(t) {
